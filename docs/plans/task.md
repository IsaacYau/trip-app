...
| --- | --- | --- | --- |
| task-1 | Refactor auth-modal HTML in scheduler.html | done | |
| task-2 | Implement styling for tabs & scrollbar in scheduler.css | done | |
| task-3 | Refactor State & loadAllData() Group-Specific Key Partitioning in scheduler.js | done | |
